...
![PL/SQL](https://img.shields.io/badge/PL%2FSQL-000000?style=flat-square)
...
### 🏥 [Healthcare Billing Analytics](https://github.com/HarshaliOnGit/first-project)

**Full-stack analytics dashboard for healthcare billing claims**

- Real-time claims analytics & summary metrics
- Provider & insurance breakdowns, procedure profitability
- Searchable claims table with filters, CSV export, PWA support
- ETL pipeline for mock data generation
- E2E tests with Playwright

**Tech Stack:** `FastAPI` `React` `Vite` `Tailwind CSS` `Recharts` `SQLite` `Docker`
...
| Company | Role | Focus |
|---------|------|-------|
| **Medicnet Pty** | Application Developer | PHP, Drupal, MySQL, Tableau dashboards |
| **Azentio Software** | Software Specialist | Database development, Treasury systems, Team lead |
| **3i Infotech** | Senior Software Developer | PL/SQL, Lending & Factoring solutions (UAE, UK banks) |
...
|---------------|--------------|------------------|-----------|
| *Solving complex problems with creative technical solutions* | *Maintaining high standards in code quality and delivery* | *Effective communication and knowledge sharing* | *Continuous learning in full-stack and data technologies* |
